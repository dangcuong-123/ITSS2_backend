...
parser_add.add_argument(
    'name', type=str, help='User\'s name (eg: vai)', location='json')
parser_add.add_argument(
    'email', type=str, help='User\'s email', location='json')
parser_add.add_argument(
    'password', type=str, help='User\'s password (eg: password)', location='json')
parser_add.add_argument('image_url', type=str,
                        help='User\'s image url (eg: sfdfsdf)', location='json')
